  ...
  window.onload=function(){
    ...
    let explain = [
       ("★五星等級老饕推薦，簡單香煎就可上桌 \n ★已去鱗去骨去刺，料理方便，營養價值高 \n ★肉質細緻有彈性，紮實鮮甜，油脂豐富入口滑順 \n 重量：約200g*4片 \n 內容物：鮭魚 \n 保存方式：冷凍-18度c以下 \n 食用方法：解凍後充分煮熟食用。請勿重複回溫解凍，解凍後盡快食用完畢。")
        ...
        ,('是一款義大利特色食物，其發源地是義大利的拿坡里，如今在全球頗受歡迎，披薩餅店分佈於世界各地。\n披薩餅的做法通常是以發酵過的圓麵餅皮上面覆蓋番茄醬、起司及其他配料，並由烤爐烤制而成。\n起司的種類以莫札瑞拉起司（Mozzarella）較常見，也有混用幾種起司的形式，包括帕馬森起司（Parmesan）、羅馬起司（Romano）、義大利鄉村軟酪（Ricotta）或蒙特里傑克起司（Monterey Jack）等。')
    ]
    /*放入圖片 */
